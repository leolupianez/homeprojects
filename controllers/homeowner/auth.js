...
module.exports = {
    ...
    postRegister: (req, res, next) => {
        ...
        // Not a valid email
        if (!validator.isEmail(email)) validationErrors.emailError = true;
        // Password is not at least 6 characters
        if (!validator.isLength(password, { min: 6 })) validationErrors.passwordError = true;
        // Does password match the password confirmation
        if (!validator.equals(confirmPassword, req.body.password)) validationErrors.confirmError = true;
